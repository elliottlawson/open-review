...
| `skills/writing-skills/SKILL.md` | **Source of truth** for writing skills — the twelve rules every SKILL.md in this repo follows |
...
Follow `/writing-skills` (`skills/writing-skills/SKILL.md`) when creating or editing any skill in this repo — it is the source of truth for the rules CI enforces on skill files.
