...
The explanation of the verdict. **Important:** Do NOT include verdict labels, emojis, or status text in this field. The presentation layer renders the verdict. This field answers *why*.
